...
<body>
  <div class="container">
    <div class="jumbotron">
      <h1>JavaScript Users code sample</h1>
        ...
        <div class="row">
          ...
          <form class="form-horizontal" role="form">
            <div class="form-group">
              <label class="control-label col-sm-2" for="usr_sgn_p_lgn">Login:</label>
              <div class="col-sm-6">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <input type="password" class="form-control" id="usr_sgn_p_pwd" placeholder="Enter password">
              </div>
            </div>
            <div class="form-group">
    ...
    <a href="https://github.com/QuickBlox/quickblox-javascript-sdk/tree/master/samples/users"
